    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>
            Hello! My name is vivek and I enjoy creating things that
            live on the internet I have always had a knack for
            technology and  been working with computers. In 2018 I started working
            with HTML and CSS to make some minor edits on a small business
            website . What I thought was just a few small edits
